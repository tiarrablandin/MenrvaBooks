...
export function CustomNavbar() {
  ...
  const navList = (
    <ul className={`${inter.className} mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6`}>
      <Typography
        as="li"
        variant="small"
        className="flex items-center gap-x-2 p-1 font-medium font-[#673C4F]"
      >
        <svg
          width="16"
          height="15"
  ...
  return (
    <Navbar className="sticky min-w-full px-4 py-2 lg:px-8 lg:py-3 bg-[#e1bee7]">
      <div className="container mx-auto flex flex-wrap items-center justify-between text-blue-gray-900">
        ...
        <div className="hidden items-center gap-x-2 lg:flex">
          ...
          <Button size="md" className="rounded-lg bg-[#673C4F]">
            Search
          </Button>
        </div>
        <IconButton
