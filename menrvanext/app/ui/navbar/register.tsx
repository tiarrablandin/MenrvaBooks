...
const RegisterForm: React.FC<RegisterFormProps> = ({ }) => {
    ...
    return (
        <>
            <Typography as={"a"} variant='small' onClick={handleOpen} className="flex items-center gap-x-2 mt-1 text-[#673C4F] cursor-pointer font-normal text-base">Register</Typography>
