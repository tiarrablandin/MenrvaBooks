...
export function CustomNavbar() {
  ...
  return (
    // <Navbar className="absolute top-0 w-full" children={undefined}>

    // </Navbar>
    <Navbar className="sticky top-0 w-full mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4 bg-[#e1bee7]">
