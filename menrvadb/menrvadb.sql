...
insert into user (id, role, first_name, last_name, tag, email, username, password, active, date_added, date_updated,
                  subscription_id)
Values (2, 'Admin', 'Matthew', 'Tilley', '@matt', 'matthew.tilley77@gmail.com', 'matt', 'Forauir11!!', 1, NOW(), null,
        1);
...
Values (4, 'Admin', 'William', 'Slaunwhite', '@will', 'williamslaunwhite@gmail.com', 'will',
        '$2a$12$.aXI64OEVlXoGf8fNHOlhef6SFgQzI4bqn2unNELnfIWTPwJj.zR6', 1, NOW(), null, 1);
...
VALUES (1, null, 'J.T. Elliott', 'Hello, I write books.', 'Announcements', now(), 1, null, 1);

insert into author (id, photo, pen_name, bio, text, date_created, reviewed, date_updated, user_id)
VALUES (2, null, 'Matthew Blackmore', 'Hello, I write books.', 'Announcements', now(), 1, null, 2);

insert into author (id, photo, pen_name, bio, text, date_created, reviewed, date_updated, user_id)
VALUES (3, null, 'Jonathan Dominguez', 'Hello, I write books.', 'Announcements', now(), 1, null, 3);

insert into author (id, photo, pen_name, bio, text, date_created, reviewed, date_updated, user_id)
VALUES (4, null, 'Amarah Calderini', '', '', now(), 1, null, null);

insert into author (id, photo, pen_name, bio, text, date_created, reviewed, date_updated, user_id)
VALUES (5, null, 'S.E. Babin', '', '', now(), 1, null, null);

insert into book (id, cover, title, description, page_count, publication_date, date_added, reviewed, date_updated, series_id)
...
values (11, 'https://i.imgur.com/Qdz9MBc.jpg', 'A Touch of Angel (Cocktails in Hell Book 5)',
        ...
        228, '2024-03-05', now(), 1, null, 3);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (1, 'Fantasy', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (2, 'Fiction', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (3, 'Non-fiction', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (4, 'Urban-fantasy', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (5, 'Science fiction', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (6, 'Mystery', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (7, 'Historical fiction', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (8, 'Horror', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (9, 'Romance', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (10, 'Thriller', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (11, 'Autobiography', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (12, 'Young Adult', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (13, 'Adventure', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (14, 'Dystopian', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (15, 'Contemporary fiction', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (16, 'Literary fiction', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (17, 'Historical', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (18, 'Graphic novel', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (19, 'Magical realism', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (20, 'Shot story', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (21, 'Biography', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (22, 'Classics', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (23, 'Paranormal romance', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (24, 'Paranormal', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (25, 'Western fiction', now(), 1, null);

insert into genre (id, name, date_added, reviewed, date_updated)
VALUES (26, 'Comedy', now(), 1, null);

insert into sub_genre (id, name, date_added, reviewed, date_updated)
VALUES (1, 'Dark fantasy', now(), 1, null);

insert into sub_genre (id, name, date_added, reviewed, date_updated)
VALUES (2, 'High fantasy', now(), 1, null);

insert into sub_genre (id, name, date_added, reviewed, date_updated)
VALUES (3, 'Low fantasy', now(), 1, null);

insert into sub_genre (id, name, date_added, reviewed, date_updated)
VALUES (4, 'Erotica', now(), 1, null);

insert into sub_genre (id, name, date_added, reviewed, date_updated)
VALUES (5, 'Gothic fiction', now(), 1, null);

insert into sub_genre (id, name, date_added, reviewed, date_updated)
VALUES (6, 'Fairy tale', now(), 1, null);

insert into sub_genre (id, name, date_added, reviewed, date_updated)
VALUES (7, 'Crime', now(), 1, null);

insert into sub_genre (id, name, date_added, reviewed, date_updated)
VALUES (9, 'Action', now(), 1, null);

insert into sub_genre (id, name, date_added, reviewed, date_updated)
VALUES (10, 'Supernatural', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (1, 'Fairy', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (2, 'Faerie', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (3, 'Fey', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (4, 'Fae', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (5, 'Shifters', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (6, 'Vampires', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (7, 'Dragons', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (8, 'Hell', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (9, 'Underworld', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (10, 'Magic', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (11, 'Mages', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (12, 'Magical artifacts', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (13, 'Griffins', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (14, 'Magical creatures', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (15, 'Werewolves', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (16, 'Alpha', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (17, 'Omega', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (18, 'Mermaids', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (19, 'Sirens', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (20, 'Witches', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (21, 'Ghosts', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (22, 'Elves', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (23, 'Orcs', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (24, 'Myths', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (25, 'Legends', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (26, 'Folklore', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (27, 'Swords', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (28, 'Dwarves', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (29, 'Gargoyles', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (30, 'Gods', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (31, 'Trolls', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (32, 'Goblins', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (33, 'Parallel worlds', now(), 1, null);

insert into keyword (id, name, date_added, reviewed, date_updated)
VALUES (34, 'Realms', now(), 1, null);
...
insert into comment (id, comment, date_added, reviewed, date_updated, user_id, book_id)
VALUES (2, 'Love this series. Can''t wait for the next!', now(), 1, null, 1, 3);
...
VALUES (1, 'The Time of Tears', now(), 1, null);

insert into series (id, name, date_added, reviewed, date_updated)
VALUES (2, 'Dark World Trilogy', now(), 1, null);
